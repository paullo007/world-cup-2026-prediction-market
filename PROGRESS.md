...
**Last updated:** 2026-06-18 (end of Session 12 — Matches-tab goalscorers UI: list scorers, split home/away into two columns, add goal **assists**, then **fix penalty goals being dropped**; plus the "Top-10 Goal Scorers of All Time" panel on the Goals tab). Shipped live on `main`, deploys verified green, scorers backfilled into the live DB. HEAD = `d33f44b`.
